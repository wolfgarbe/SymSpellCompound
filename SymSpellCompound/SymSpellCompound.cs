...
public static class SymSpellCompound
{
	public static bool enableCompoundCheck = true;
    ...
    public static int verbose = 0; //ALLWAYS use verbose = 0 if enableCompoundCheck = true!
    //0: top suggestion
    ...
    public static Dictionary<string, Int32> dictionary = new Dictionary<string, Int32>(); //initialisation
